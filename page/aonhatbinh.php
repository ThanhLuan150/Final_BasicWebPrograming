...
<body>
    ...
    <div class="phucvu">
        <div class="container">
            <div class="title">
            <p class="titlep1"><i class="fa-solid fa-arrow-left" onclick="javascript:history.go(-1);"></i>  ÁO NHẬT BÌNH</p>
                <div class="listmenu">
                    <div class="listmenu1">
    ...
    <div class="noidung"> 
        <div class="container">
            <div class="noiquy">
                <div class="gioithieu">
                    <p class="gioithieu1">Áo nhật bình là trang phục không thể thiếu trong cung đình thời sưai. Đó là nét văn hóa đặc trưng đẹp đẽ của mảnh đất hình chữ S chúng ta. Tuy nhiên, để lựa chọn một địa chỉ cho thuê áo cổ phục giá rẻ- chất lượng – uy tín, thì không phải chuyện dễ dàng. Ngoài ra, còn nhiều vấn đề liên quan đến dịch vụ cho thuê cổ phục. Tất cả sẽ được Áo Cổ phục TTDVL chia sẻ tại đây.</p>
                    <p class="gioithieu2">Áo nhật bình– Gam màu phụ giúp cho bộ ảnh của bạn thêm phần ấn tượng</p>
                </div>
                <div class="chothue">
