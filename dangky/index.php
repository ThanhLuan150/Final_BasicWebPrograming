     ...
     <div class="signup-content">
            ...
            <form method="" class="register-form">
                <div class="form-group">
                    ...
                    <input class="front-input" type="text" name="name" id="name" placeholder="Tên của bạn"  >
                    <label for="email"></label>
                    <input class="front-input" type="email" name="email" id="email" placeholder="Email của bạn" >
                    <label for="pass"></label>
                    <input class="front-input" type="password" name="pass" id="pass" placeholder="Mật khẩu" >
                    <label for="re-pass"></label>
                    <input class="front-input" type="password" name="re_pass" id="re_pass" placeholder="Lặp lại mật khẩu của bạn" >
                    <input type="checkbox" name="agree-term" id="agree-term" class="agree-term">
             <font class="chatbox" style="vertical-align: inherit;">Tôi đồng ý với điều khoản dịch vụ</font>
                    </div>
                    <div class="form-group form-button">
                    <font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><input type="submit" name="signup" id="signup" class="form-submit" value="Đăng ký" fdprocessedid="mbk6rh"></font></font>
                </div>
                </form>
            </div>
